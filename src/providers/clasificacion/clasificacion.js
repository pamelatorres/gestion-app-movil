...
*/
var ClasificacionProvider = (function () {
    function ClasificacionProvider(http) {
        this.http = http;
        console.log('Hello ClasificacionProvider Provider');
    }
    ClasificacionProvider.prototype.load = function () {
        var _this = this;
        if (this.data1) {
    ...
    return ClasificacionProvider;
}());
ClasificacionProvider = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [Http])
], ClasificacionProvider);
export { ClasificacionProvider };
